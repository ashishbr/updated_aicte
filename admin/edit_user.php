...
if(isset($_POST["update"])){
  ...
  $sql_email="SELECT * FROM `user` WHERE `usn`= '$email1'";
  ...
  if( $usn!= $email1 && mysqli_num_rows($db_email)!=0){
 ...
 elseif($phone_number!= $phone_number1 && mysqli_num_rows($db_phone)!=0){
    ...
    $sql_update = "UPDATE `user_info`.`user` set `name`= '$name1' , `usn` = '$email1',`phone_number`= '$phone_number1',`usertype`='$usertype1'   where `id` = '$user_id' ";
    $result = mysqli_query($data, $sql_update);
    if($result)
  {
    echo "<script>alert('User information updated successfully!');</script>";
    ...
    <nav class="navbar navbar-default">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#">AICTE ACTIVITY DBMS</a>
        </div>
    ...
    <section id="main">
        ...
        <div class="row">
          <div class="col-md-3">
            <div class="list-group">
              ...
              <a href="organization.php" class="list-group-item"><span class="glyphicon glyphicon-glass" aria-hidden="true"></span> organization </a>
      ...
      <div class="modal-body">
       <div class="form-group">
        ...
        <div class="form-group">
          <label>Email</label>
          <input type="usn" name="usn" class="form-control" placeholder="Email"  value="<?php echo $usn; ?>" required>
        </div>
        <div class="form-group">

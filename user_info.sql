...
-- Procedures
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `getBookings` (IN `emailid` VARCHAR(25)) 
 SELECT * FROM event_booking, equipments WHERE usn = emailid and event_booking_id = id$$
